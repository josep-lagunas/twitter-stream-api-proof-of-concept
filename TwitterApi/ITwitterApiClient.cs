...
namespace TwitterApi
{
    public interface ITwitterApiClient
    {
        ...
        void SetCredentials(string consumerKey, string consumerSecretKey, string accessToken,
            string accessTokenSecret);

        bool StartStreamingTweets(string id, IEnumerable<string> hashtags,
            IEnumerable<string> languages, IEnumerable<MapBoxCoordinates> mapBoxCoordinates,
            TwitterApiClient.StreamTweetByHashtagHandler streamTweetHandler);

        void StartStreamingTweets(string id, IEnumerable<string> hashtags,
